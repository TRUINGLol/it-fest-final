        ...
        <div className={cl.main}>
            ...
            <div className={cl.banner5}>
                ...
                <div className={cl.cards}>
                    ...
                    <PrjCard button={false} title={"Светлое Будущее"} content={"Организация пунктов сбора вторичных материалов, проведение кампаний по обучению населения о сортировке мусора, сотрудничество с местными перерабатывающими предприятиями."}/>
                    <PrjCard button={false} title={"Чистые Реки"} content={"Проведение регулярных акций по сбору мусора с участием местных жителей, создание информативных стендов о важности чистоты водоемов и их экосистемы. Также можно разработать программу мониторинга состояния воды."}/>
                </div>
